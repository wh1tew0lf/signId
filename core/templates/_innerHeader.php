            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="top-nav navbar-nav">
                        ...
                        <li><a href="/demo-shop/?email=<?php echo $this->getOwner()->getUser('email', ''); ?>" target="_blank">Sign in cloud demo page</a></li>
                        <li><a href="/signature/?uid=<?php echo $this->getOwner()->getUser('uid', ''); ?>" target="_blank">Signature</a></li>
